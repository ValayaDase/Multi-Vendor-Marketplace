        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50/80 border-b border-gray-100">
              <th className="p-6 text-xs font-bold text-gray-400 uppercase tracking-tighter">
                Product Details
              </th>
              <th className="p-6 text-xs font-bold text-gray-400 uppercase tracking-tighter">
                Category
              ...
              <th className="p-6 text-xs font-bold text-gray-400 uppercase tracking-tighter text-right">
                Verification
              </th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-50">
            {pendingProducts.map((p) => (
              <tr
                key={p._id}
                className="hover:bg-gray-50/30 transition-all duration-300"
              >
                {/* Product & Seller Info */}
                <td className="p-6">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm text-gray-500 font-medium">
                          Seller: {p.seller?.name || "Premium Vendor"}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <td className="p-6">
                  <div className="flex flex-col">
                    ...
                    <span
                      className={`text-[11px] font-medium ${p.stock > 0 ? "text-emerald-500" : "text-rose-500"}`}
                    >
                      {p.stock > 0
