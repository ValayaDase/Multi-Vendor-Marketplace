...
import { MdStorefront, MdShoppingBag, MdPersonAdd, MdLogout } from 'react-icons/md';

const Sidebar = () => {
  const menuItems = [
    { name: 'Dashboard', path: '/admin/dashboard', icon: <AiOutlineHome size={22} /> },
    { name: 'Sellers', path: '/admin/sellers', icon: <MdStorefront size={22} /> },
    { name: 'Orders', path: '/admin/orders', icon: <MdShoppingBag size={22} /> },
    { name: 'Requests', path: '/admin/requests', icon: <MdPersonAdd size={22} /> },
    { name: 'Approval Queue', path: '/admin/approval-queue', icon: <MdPersonAdd size={22} /> },
  ];
