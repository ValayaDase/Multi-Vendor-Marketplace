...
export default function BuyersDashboard() {
  ...
  const [results, setResults] = useState({ artists: [], products: [] });
  ...
  >
    ...
    <div className="relative h-full flex flex-col justify-center px-12 lg:px-16 max-w-2xl">
      ...
      <p className="text-white/80 text-lg leading-relaxed max-w-lg font-light">
        Discover millions of products across fashion, home essentials, and lifestyle. 
        Unbeatable quality, delivered to your doorstep.
      </p>
...
//   // Multi-Vendor Categories (Generic & Clean)
//   const categories = [
//     { id: 1, title: "Electronics", slug: "electronics", image: "https://images.unsplash.com/photo-1498049794561-7780e7231661?w=400&q=80" },
//     { id: 2, title: "Fashion", slug: "fashion", image: "https://images.unsplash.com/photo-1445205170230-053b83016050?w=400&q=80" },
//     { id: 3, title: "Home & Living", slug: "home-living", image: "https://images.unsplash.com/photo-1484101403633-562f891dc89a?w=400&q=80" },
//     { id: 4, title: "Gadgets", slug: "gadgets", image: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&q=80" },
//     { id: 5, title: "Accessories", slug: "accessories", image: "https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&q=80" },
//   ];
...
//             Showing results for <span className="text-gray-400">"{query}"</span>
//           </h2>
...
//                   key={p._id} 
//                   onClick={() => navigate(`/buyer/product/${p._id}`)}
//                   className="group cursor-pointer border border-gray-100 rounded-lg p-3 hover:shadow-md transition bg-white"
//                 >
//                   <div className="aspect-square bg-gray-50 rounded-md overflow-hidden mb-3">
//                     <img src={getImageUrl(p.images?.[0])} alt={p.title} className="w-full h-full object-cover group-hover:scale-105 transition duration-500" />
//                   </div>
//                   <h4 className="text-sm font-bold text-gray-800 truncate">{p.title}</h4>
//                   <p className="text-lg font-black text-gray-900 mt-1">₹{p.price.toLocaleString("en-IN")}</p>
//                 </div>
//               ))}
//             </div>
//           )}

//           {/* Found Shops (Formerly Artists) */}
//           {results.artists.length > 0 && (
//             <div className="mt-10">
//               <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Top Rated Shops</p>
//               <div className="flex gap-4 overflow-x-auto pb-4">
//                 {results.artists.map((a) => (
//                   <div 
//                     key={a._id}
//                     onClick={() => navigate(`/buyer/shop/${a._id}`)}
//                     className="flex-shrink-0 flex items-center gap-3 bg-white border border-gray-100 p-4 rounded-xl cursor-pointer hover:border-black transition"
//                   >
//                     <div className="w-10 h-10 bg-gray-900 text-white rounded-full flex items-center justify-center font-bold">{a.name[0]}</div>
//                     <span className="font-bold text-gray-800 pr-4">{a.name}</span>
//                   </div>
//                 ))}
//               </div>
//             </div>
...
//           {results.products.length === 0 && results.artists.length === 0 && (
//             <div className="text-center py-20 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
//               <p className="text-gray-400 font-medium">No products or shops found for your search.</p>
//             </div>
//           )}
//         </div>
//       )}

//       {/* 2. HERO BANNER - Clean & Direct */}
//       {!query && (
//         <div className="relative h-[400px] bg-gray-900 rounded-2xl overflow-hidden flex items-center px-12">
//           {/* Subtle background pattern or image */}
//           <div className="absolute inset-0 opacity-40">
//              <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1600&q=80" className="w-full h-full object-cover" alt="Hero" />
//           </div>
//           <div className="relative z-10 max-w-xl">
//             <span className="text-xs font-black text-white/60 uppercase tracking-[0.2em] mb-4 block">Premium Marketplace</span>
//             <h1 className="text-5xl font-black text-white leading-tight mb-6">
//               Quality Products, <br /> Direct from Vendors.
//             </h1>
//             <button 
//               onClick={() => navigate("/buyer/all")}
//               className="bg-white text-black px-8 py-3.5 rounded font-bold hover:bg-gray-100 transition shadow-xl"
//             >
//               Start Shopping
//             </button>
//           </div>
...
//       {/* 3. CATEGORIES - Grid Style */}
//       <section>
//         <div className="flex items-center justify-between mb-8">
//           <h3 className="text-xl font-black text-gray-900 uppercase tracking-tight">Browse Categories</h3>
//         </div>
...
//             >
//               <img src={cat.image} className="w-full h-full object-cover transition duration-700 group-hover:scale-110 opacity-90 group-hover:opacity-100" alt={cat.title} />
//               <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent" />
//               <div className="absolute bottom-6 left-6">
//                 <h4 className="text-white font-bold text-lg">{cat.title}</h4>
//                 <p className="text-white/60 text-[10px] font-bold uppercase tracking-widest mt-1">Explore Now</p>
//               </div>
//             </div>
//           ))}
//         </div>
